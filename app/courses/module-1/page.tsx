      ...
      <div className="space-y-5 pb-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>
            {lang === 'es'
              ? `${MODULE_1_QUIZ.length} preguntas • Necesitas ${meta.passThreshold * 100}% para aprobar`
              : `${MODULE_1_QUIZ.length} questions • Need ${meta.passThreshold * 100}% to pass`}
          </p>
        </div>

        <QuizPlayer
          questions={MODULE_1_QUIZ}
