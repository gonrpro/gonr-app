...
export default function ProtocolBuilderPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-xl font-bold tracking-tight">{t('protocolBuilderTitle')}</h1>
        <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
          {t('protocolBuilderSubtitle')}
        </p>
      </div>
      ...
      <div className="space-y-2">
        <label className="text-sm font-semibold">{t('protocolLabelStain')}</label>
        <select
          value={stain}
        ...
        >
          <option value="">{t('protocolSelectStain')}</option>
      ...
      {/* Fiber selector */}
      <div className="space-y-2">
        <label className="text-sm font-semibold">{t('protocolLabelFiber')}</label>
        <select
          value={fiber}
          ...
          className="w-full rounded-lg bg-white dark:bg-[#0e131b] border border-gray-200 dark:border-white/10
            ...
            focus:outline-none focus:ring-2 focus:ring-green-500/50"
        >
          <option value="">{t('protocolSelectFiber')}</option>
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-semibold">{t('protocolSteps')}</h2>
          ...
          >
            ...
            <select
              ...
              className="w-full rounded-lg bg-white dark:bg-[#0e131b] border border-gray-200 dark:border-white/10
                ...
                focus:outline-none focus:ring-2 focus:ring-green-500/50"
            >
              <option value="">{t('protocolSelectAgent')}</option>
              {AGENTS.map((agent) => (
            ...
            <input
              ...
              placeholder={t('protocolDwellTimePlaceholder')}
              className="w-full rounded-lg bg-white dark:bg-[#0e131b] border border-gray-200 dark:border-white/10
            ...
            <textarea
              ...
              rows={2}
              placeholder={t('protocolInstructionPlaceholder')}
              className="w-full rounded-lg bg-white dark:bg-[#0e131b] border border-gray-200 dark:border-white/10
      ...
      <div className="space-y-2">
        <label className="text-sm font-semibold">
          {t('protocolSafetyWarnings')}{' '}
          <span className="font-normal" style={{ color: 'var(--text-secondary)' }}>
            {t('protocolOnePerLine')}
          </span>
        </label>
        <textarea
      ...
      >
        {saving ? t('protocolSaving') : t('protocolSaveProtocol')}
      </button>
