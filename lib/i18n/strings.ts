...
// ── TierGate ──────────────────────────────────────────────────
  ...
  "intake.contextEmptyStain": { en: "A stain to look at", es: "Una mancha por revisar" },
  ...
  "intake.read.looksLikeStainFallback": { en: "Looks like a stain", es: "Parece una mancha" },
  ...
  "intake.loading.fabricRisk": { en: "Checking fabric risk", es: "Revisando el riesgo para la tela" },
  ...
  "intake.progress": { en: "Question {current} of {total}", es: "Pregunta {current} de {total}" },
  ...
  "chat.highCareNote": { en: "This looks like a higher-care item, so I’ll stay cautious and won’t guess — better to be sure than sorry.", es: "Esto parece una prenda delicada, así que seré prudente y no adivinaré: mejor prevenir que lamentar." },
