...
export function formatRetrievedContext(result: RetrievalResult): string {
  ...
  return [
    ...
    '',
    'The following excerpts were retrieved from the GONR knowledge base (textile-care primary sources, Stamford Fabritec, NCA, UCLA, internal GONR chemistry + safety notes, etc.) for this specific query. Use them as primary source-of-truth. If an excerpt contradicts the generic methodology earlier in this prompt, prefer the excerpt for this specific stain × fiber case.',
    '',
