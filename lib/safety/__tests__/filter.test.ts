...
describe('SAFE_FALLBACK', () => {
  test('has required fields', () => {
    ...
    expect(SAFE_FALLBACK.homeSolutions).toHaveLength(4)
    expect(SAFE_FALLBACK.homeSolutions[0]).toContain('keep the item away from heat')
    expect(SAFE_FALLBACK.homeSolutions.join(' ')).toContain('If you are going to do anything')
