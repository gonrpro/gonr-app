...
const VARIANT: Record<Variant, string> = {
  primary:
    'bg-[var(--accent)] text-[#031007] shadow-[0_10px_30px_rgba(var(--brand-green-rgb),0.35)] hover:-translate-y-0.5',
  tile:
  ...
  accent:
    'bg-[var(--accent-soft)] text-[var(--accent)] border border-[rgba(var(--brand-green-rgb),0.3)] hover:opacity-90',
  warning:
